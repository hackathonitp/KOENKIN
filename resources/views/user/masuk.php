      ...
      <div class="container">
        <form action="Login" method="post">
          ...
          <div class="input-field">
            <input type="text" class="input" placeholder="Nama Pengguna" name="user" />
            <i class="bx bx-user"></i>
          </div>

          <div class="input-field">
            <input type="Password" class="input" placeholder="Kata sandi" name="pass" />
            <i class="bx bx-lock-alt"></i>
          </div>

          <div class="input-field login">
            <input type="submit" class="masuk" value="masuk" id="btn-login" />
          </div>
